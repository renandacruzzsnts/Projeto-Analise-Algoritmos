...
import org.yourcompany.yourproject.desempenho.ExecutorDeBenchmark;
import org.yourcompany.yourproject.desempenho.HistoricoResultados;
import org.yourcompany.yourproject.desempenho.Metricas;
import org.yourcompany.yourproject.interface_grafica.VisualizadorGraficoDesempenho;
import org.yourcompany.yourproject.interface_grafica.VisualizadorTabelaResultados;
import org.yourcompany.yourproject.ordenacao.AlgoritmoDeOrdenacao;
import org.yourcompany.yourproject.ordenacao.OrdenacaoBolha;
import org.yourcompany.yourproject.ordenacao.OrdenacaoPorInsercao;
import org.yourcompany.yourproject.ordenacao.OrdenacaoPorMesclagem;
import org.yourcompany.yourproject.ordenacao.OrdenacaoPorPilha;
import org.yourcompany.yourproject.ordenacao.OrdenacaoPorSelecao;
import org.yourcompany.yourproject.ordenacao.OrdenacaoRapida;
import org.yourcompany.yourproject.utilidades.GeradorDeDados;
...
public class AlgoritmosDeOrdenacao {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.print("\nDeseja ordenar mais valores? (S/N): ");
            continuar = scanner.nextLine().trim().toUpperCase();
            
            if (continuar.equals("S")) {
                System.out.println("\n" + "=".repeat(60));
                System.out.println("    NOVA ANÁLISE DE ALGORITMOS DE ORDENAÇÃO");
